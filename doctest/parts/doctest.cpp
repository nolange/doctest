...
namespace detail {
    ...
    bool isDebuggerActive() {
        // 135 bytes is currently enough to get TracerPid on Linux 6.11 with 32bit pids
        alignas(intmax_t) char buffer[256];
...
#elif (defined(DOCTEST_PLATFORM_MAC) || defined(CATCH_PLATFORM_IPHONE)) &&                         \
